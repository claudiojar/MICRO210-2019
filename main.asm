...
reset:		
	...
	ldi b0, 30		; initialize Tmax = 20°C (0x14)
	rjmp	main
...
colour_blue1 : .db 0xf0, 0x90, 0xf0		;used for temps below 22
colour_blue2 : .db 0xb2, 0x66, 0xf0	;used for temps between 22 ans 24
colour_green : .db 0xff, 0x01, 0x00		;used for temps between 24 and 25
colour_yellowish : .db 0x66, 0xcc, 0x00 ;used for temps between 25 and 27 
colour_orange : .db 0x35,0xff, 0x01		;used for temps above 27 
